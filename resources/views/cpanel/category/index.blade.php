...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{trans('category.category')}}</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text">{{trans('category.category')}}</span>
                        </a>
                    </li>
                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        <li class="m-portlet__nav-item">
                            <a href="{{asset('cpanel/category/create')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--air">
                                <span>
                                        <i class="la la-plus"></i>
                                        <span> {{trans('category.add_category')}}</span>
                                </span>
                            </a>
                        </li>
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            var table = $('#m_table_1').DataTable({
                ...
                ajax: '{!! URL::asset('/cpanel/category/datatable') !!}',
                columns : [
                    { data: 'id'              , name:'id'},
