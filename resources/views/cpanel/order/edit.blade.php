               ...
               <div class="m-portlet__body row">
                  ...
                  <div class="form">
                        ...
                        <div class="form-group">
                           ...
                           {{Form::select('category_id', $category, $product->category_id,['class' => 'form-control mb-3 awesome','placeholder' => trans('products.category')])}}
                        </div>
                        <div class="form-group">
                           {{Form::label('body', trans('products.subCategory'))}}
                           {{Form::select('sub_category_id', $subCategory, $product->sub_category_id,['class' => 'form-control mb-3 awesome','placeholder' => trans('products.subCategory')])}}
                        </div>
                        <div class="form-group">
