        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="" class="m-nav__link">
                            <span class="m-nav__link-text">{{trans('order.under_approval')}}</span>
                        </a>
                    </li>
                </ul>
            </div>
...
@section('js')
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            var table = $('#m_table_1').DataTable({
                ...
                ajax: '{!! URL::asset('/cpanel/order/underApproval/datatable') !!}',
                columns : [
                    { data: 'id'              , name:'id'},
    ...
    <script>
        $(document).on('click', '.success', function (e) {
            ...
            var id = $(this).data('id');
            swal({
                title: "{{trans('order.do_you_agree_order')}}",
                type: "info",
                ...
                function(result) {
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            type: "post",
                            url: "{{url('/cpanel/order/underApproval/agreeOrder')}}",
                            data: {id: id},
